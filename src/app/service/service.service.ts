...
export default class ServiceService {
  usuarios: any;
  url = 'http://192.168.0.110:3000/api/'; 
  urlUser = 'http://192.168.0.110:3000/api/usuarios'; 
  urlLogin = 'http://192.168.0.110:3000/api/login'
  urlBase = 'http://192.168.0.110:3000/api/choferCarros/';
  urlViajeChofer = 'http://192.168.0.110:3000/api/viajeChofer';
  choferCarros: any;
  viajeChofer:any;
  choferes: any;
